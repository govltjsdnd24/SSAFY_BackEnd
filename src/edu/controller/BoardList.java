...
public class BoardList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Board row:list) {
			out.println("            <tbody>");
			out.println("              <tr class=\"text-center\">");
			out.println("                <th scope=\"row\">" +row.getArticleNo()  +"</th>");
			out.println("                <td class=\"text-start\">");
			out.println("                  <a");
			out.println("                    href=\"#\"");
			out.println("                    class=\"article-title link-dark\"");
			out.println("                    data-no=\""+ row.getArticleNo()+"\"");
			out.println("                    style=\"text-decoration: none\"");
			out.println("                  >");
			out.println("                    "+row.getSubject());
			out.println("                  </a>");
			out.println("                </td>");
			out.println("                <td>"+row.getUsername()+"</td>");
			out.println("                <td>"+row.getHit()+"</td>");
			out.println("                <td>"+row.getRegisterTime()+"</td>");
			out.println("              </tr>");
			out.println("            </tbody>");
		}
		...
		out.println("        location.href = \"/board1_servlet/view?viewno=\" + this.getAttribute(\"data-no\");");
		out.println("        });");
		out.println("      });");
		out.println("");
